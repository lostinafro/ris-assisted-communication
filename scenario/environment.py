...
class Box:
    """Creates an scenario defined by a box of UEs.
    ...
    def place_bs(
        ...
        """Place a single BS in the scenario. Following the paper, the BS is always located at the second quadrant of
    ...
    def place_ris(self,
        ...
        """Place a single RIS in the scenario. If a new RIS is set the old one is canceled.
